...
public class RenderDecoLamp extends TileEntitySpecialRenderer<TileDecoLamp> {


    public static int pass;

    public RenderDecoLamp() {
    }
    ...
    public void renderTileEntityAt(TileDecoLamp te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        if (pass != 0) {
            ...
            Util.drawColoredCube(cube, rgbColor.getR() / 256D, rgbColor.getG() / 256D, rgbColor.getB() / 256D, powerDivision * 0.725D, drawfaces);
